...
<html lang="en">
  ...
  <body>
                  ...
                  <div class="col-sm-8 col-md-3">
                      <form action="#" class="busqueda">
                          <div class="input-group">
                              <input type="text" class="form-control" placeholder="What service are you looking for?" requiered>
        ...
        <div class="container">
            <div class="row justify-content-center buscador align-items-center">
                <div class="col-md-10">
                    ...
                    <form action="">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="what service are you looking for?" required>
                            <div class="input-group-append">
                                <input type="submit" Value="Search" class="px-5 py-3 btn btn-lg btn-success">
                            </div>
                        </div>
                    </form>
                </div>
      ...
      <section class="primeros-pasos container mt-5">
          ...
          <p class="text-center">We have been improving our processes over the years to build world-class products that offer the best nearshore experience.</p>
          <div class="row ">
